...
def main():
    ...
    parent_parser = argparse.ArgumentParser(description='Training of IGA nets')
    ...
    new_run_parser.add_argument('--epochs', '-e', default=400, type=int, help='Number of epochs to run the simulation.')
    ...
    new_run_parser.add_argument('--message', '-m', default=90, type=int, help='The length in bits of the watermark.')
    new_run_parser.add_argument('--message_reduced', '-r', default=30, type=int, help='The length in reduced message')
    new_run_parser.add_argument('--use-mc', dest='use_mc', action='store_true', help='Enable the message coding module')
    ...
    if args.command == 'continue':
        ...
        iga_config = IGAConfiguration(H=args.size, W=args.size,
                                      ...
                                      message_middle_length=args.message_reduced,
    ...
    model = IGA(iga_config, device, noiser, tb_logger)
